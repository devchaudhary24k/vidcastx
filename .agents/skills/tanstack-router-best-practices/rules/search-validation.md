  ...
  return (
    <ProductList
      ...
      filters={{
        ...
        priceRange: search.minPrice && search.maxPrice ? [search.minPrice, search.maxPrice] : undefined,
      }}
    />
  );
}
...
function ProductFilters() {
  ...
  return (
    <div>
      <select value={search.sort} onChange={(e) => updateFilters({ sort: e.target.value as ProductSearch["sort"] })}>
