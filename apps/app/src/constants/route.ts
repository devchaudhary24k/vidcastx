 ...
 */
export const authRoutes: string[] = ["/auth/login", "/auth/signup", "/auth/error", "/auth/forgot-password"];
 ...
 */
export const protectedRoutes: string[] = ["/dashboard", "onboarding", "/account", "/settings"];
